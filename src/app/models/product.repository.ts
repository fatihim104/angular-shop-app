...
export class ProductRepository {
    private products : Product[] = [
        ...
        { id: 4, name: "iphone 17", price: 50000, imageUrl: "3.jpeg", description: "iyi telefon", isActive: true, categoryId:2 },   
        { id: 5, name: "iphone 18", price: 60000, imageUrl: "3.jpeg", description: "iyi telefon", isActive: true, categoryId:3 }   
    ];
